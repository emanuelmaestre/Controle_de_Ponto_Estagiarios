...
const sec3 = [
  ...
  h2art('3.3.1 Registro de Ponto com Geolocalização e Auto-Checkout'),
...
const sec4 = [
  ...
  bullet('Registro de ponto com validação geográfica (Haversine) e timestamp servidor-autoritativo'),
  bullet('Geofence auto-checkout: encerramento automático ao sair do raio do laboratório com notificação de atividades pendentes'),
  bullet('Documentação de atividades com correção ortográfica automática Hunspell PT-BR'),
  bullet('Gamificação com pontos, 6 níveis proporcionais à duração do curso, 15 conquistas e ranking'),
  ...
  bullet('Sino de notificações persistentes para estagiários (polling 60 s): ponto em aberto, atividades pendentes, feedbacks, conquistas'),
