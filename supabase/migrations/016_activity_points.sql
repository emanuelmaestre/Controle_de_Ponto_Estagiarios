-- ============================================================
-- 016 · Pontos por atividade documentada
-- +5 pts por sessão com ao menos 1 atividade descrita (≥ 10 chars)
-- Conquistas: reporter_5 (5 sessões) e reporter_20 (20 sessões)
-- ============================================================

-- Recria o backfill com suporte à nova regra de atividade
...
BEGIN
  ...
  LOOP
    ...
    LOOP
      ...
      -- Verifica se descreveu atividade em alguma sessão do dia (≥ 10 chars)
      SELECT EXISTS (
    ...
    -- Conquistas de atividade documentada
