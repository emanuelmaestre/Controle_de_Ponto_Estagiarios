...
export default function InternUpdatesPage() {
  ...
  return (
    <div className="min-h-screen pb-24" style={{ background: 'var(--bg)' }}>
      <div className="max-w-lg mx-auto px-4 pt-6">
        ...
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-xl font-black mb-0.5" style={{ color: 'var(--text)' }}>Atualizações</h1>
          <p className="text-xs" style={{ color: 'rgba(255,255,255,0.35)' }}>
            Novidades do sistema e espaço para suas sugestões
          </p>
        </div>
        ...
        <div className="flex gap-2 mb-5">
          {[
            { key: 'news',     label: 'Novidades',  icon: <Sparkles size={13} /> },
            { key: 'feedback', label: 'Sugestões',  icon: <MessageSquare size={13} /> },
          ].map(t => (
        ...
        {tab === 'feedback' && (
          <div className="space-y-5">
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
              ...
              <p className="text-sm font-black mb-3" style={{ color: '#3fe56c' }}>Enviar sugestão</p>
              ...
              <AnimatePresence>
                {sent && (
                  <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                    ...
                    <CheckCircle2 size={12} /> Sugestão enviada! Obrigado pelo feedback.
                  </motion.p>
                )}
              </AnimatePresence>
            ...
            {myFeedbacks.length > 0 && (
              <div>
                <p className="text-[11px] font-black mb-3" style={{ color: 'rgba(255,255,255,0.3)' }}>
                  SUAS SUGESTÕES ANTERIORES
                </p>
                <div className="space-y-3">
                      ...
                      <motion.div key={fb.id}
                        ...
                        {fb.admin_reply && (
                          <div className="mt-2 pl-3 py-1 border-l-2" style={{ borderColor: '#3fe56c' }}>
                            <p className="text-[10px] font-black mb-0.5" style={{ color: '#3fe56c' }}>Resposta do admin</p>
