    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-100 shadow-sm">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-4 sm:py-5 flex items-center gap-2 sm:gap-4">
          ...
          <div>
            <h1 className="font-bold text-slate-800 text-lg sm:text-xl">Configurações</h1>
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-6 sm:py-8 pb-24 md:pb-8 space-y-6">
        ...
        <FadeIn delay={0}>
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 sm:p-6">
            <h2 className="font-semibold text-slate-800 mb-1">Configurações do laboratório</h2>
            <p className="text-sm text-slate-400 mb-5">Horários de lembrete, horas esperadas e e-mail de relatório.</p>
        ...
        <FadeIn delay={0.1}>
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 sm:p-6">
            <h2 className="font-semibold text-slate-800 mb-1">Seu PIN de acesso rápido</h2>
