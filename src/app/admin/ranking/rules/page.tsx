  ...
  return (
    <>
        ...
        <section className="rounded-xl p-6"
          ...
          <div className="space-y-3">
            {SCORING_RULES.map(rule => (
              <div key={rule.id} className="flex items-center gap-4 rounded-xl px-4 py-3"
                style={{
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold" style={{ color: rule.id === 'photo' ? '#fbbf24' : 'var(--text)' }}>
                    {rule.label}
                  </p>
          ...
          <div className="mt-4 rounded-xl px-4 py-3"
            ...
            <p className="text-sm" style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.7 }}>
              💡 <strong style={{ color: '#3fe56c' }}>Exemplo prático:</strong> Entrou pontual com sequência de 7 dias →
      ...
      <FadeIn delay={0.08}>
        <section className="rounded-xl p-6"
          style={{ background: 'var(--surface-card, #0f2318)', border: '1px solid rgba(0,200,83,0.15)' }}>
          <p className="text-[10px] font-black tracking-widest mb-4" style={{ color: 'var(--text-3)' }}>NÍVEIS</p>
      ...
      <FadeIn delay={0.12}>
        <section className="rounded-xl p-6"
          style={{ background: 'var(--surface-card, #0f2318)', border: '1px solid rgba(0,200,83,0.15)' }}>
          <p className="text-[10px] font-black tracking-widest mb-4" style={{ color: 'var(--text-3)' }}>CONQUISTAS</p>
            ...
            {Object.entries(ACHIEVEMENTS).map(([key, ach]) => (
              <div key={key} className="flex items-center gap-3 rounded-xl px-4 py-3"
                ...
                <div>
                  ...
                  <p className="text-xs" style={{ color: 'rgba(255,255,255,0.4)' }}>{ach.desc}</p>
                </div>
              </div>
            ))}
          </div>
