        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-5 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="font-bold text-slate-800 text-lg sm:text-xl">EstagiÃ¡rios</h1>
              <p className="text-slate-400 text-xs">{active.length} ativo{active.length !== 1 ? 's' : ''} Â· {inactive.length} inativo{inactive.length !== 1 ? 's' : ''}</p>
            </div>
          </div>
          <Link
          ...
          >
            +<span className="hidden sm:inline"> Novo</span> estagiÃ¡rio
          </Link>
        </div>
      </div>
            ...
            {active.length === 0 && (
              <FadeIn>
                <div className="py-10 text-center text-slate-400">
                  ...
                  <p className="text-sm">Nenhum estagiÃ¡rio ativo.</p>
                </div>
              </FadeIn>
            )}
          </StaggerContainer>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
        ...
        <span className="text-slate-300 text-base group-hover:text-blue-400 transition-colors">â€º</span>
      </div>
    </Link>
  )
}
