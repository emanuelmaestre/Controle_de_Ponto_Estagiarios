  ...
  if (report === 'sheet') {
    ...
    return NextResponse.json({
      ...
      rows: [
        ...
        { campo: 'HORAS CUMPRIDAS',    valor: mh(totalMin).toUpperCase() },
  ...
  if (report === 'summary') {
    ...
    return NextResponse.json({
      ...
      columns: [
        ...
        { header: 'Horas',      dataKey: 'horas',     width: 65 },
        { header: 'Sessões',    dataKey: 'sessoes',   width: 44 },
        { header: 'Aprovadas',  dataKey: 'aprovadas', width: 52 },
        { header: 'Atrasos',    dataKey: 'atrasos',   width: 44 },
      ],
      totals: [
