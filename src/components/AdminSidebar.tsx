...
const NAV_ITEMS = [
  ...
  { href: '/admin/interns',   label: 'Estagiários', icon: Users },
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: 'radial-gradient(circle, rgba(var(--primary-rgb,30,92,45),0.18) 0%, transparent 70%)',
          borderRadius: '50%',
        }}
      />
      <div
              ...
              >
                ...
                >
                  ...
                  <div className="relative flex-shrink-0">
                    <motion.div
                      animate={active ? { color: '#4ade80' } : { color: 'rgba(255,255,255,0.45)' }}
                    >
                      <Icon size={17} />
                    </motion.div>
